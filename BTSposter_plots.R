...
read.csv("~/OurFutureHealth/OFH_AsthmaShiftwork/data/OddsRatios_newBTS.csv") -> plot_data

plot_data %>% head

plot_data_sex <- filter(plot_data,X.1%in%c("Male3","Female3"))
plot_data_sex %>% head

plot_data_sex %>% filter(X!="(Intercept)") %>%
  .[,1:5] %>%
  rbind(.,c("Day workers","Male3","1",NA,NA)) %>%
  rbind(.,c("Day workers","Female3","1",NA,NA)) %>%
...
ggsave(plot = p_sex, filename="OurFutureHealth/OFH_AsthmaShiftwork/plots/BTS2.png",width=5,height=4)
...
ggsave(plot = p_age, filename="OurFutureHealth/OFH_AsthmaShiftwork/plots/BTS_agestrat.png",width=10,height=4)
...
ggsave(plot = p_compill, filename="OurFutureHealth/OFH_AsthmaShiftwork/plots/BTS_comppill.png",width=5,height=4)
...
ggsave(plot = p_cont, filename="OurFutureHealth/OFH_AsthmaShiftwork/plots/BTS_cont.png",width=5,height=4)
...
ggsave(plot = p_men, filename="OurFutureHealth/OFH_AsthmaShiftwork/plots/BTS_men1.png",width=5,height=4)
#####
...
ggsave(plot = p_men, filename="OurFutureHealth/OFH_AsthmaShiftwork/plots/BTS_men2.png",width=5,height=4)
